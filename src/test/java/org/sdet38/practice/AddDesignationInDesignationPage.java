...
public class AddDesignationInDesignationPage
{
	public static void main(String[] args) throws Throwable
	{
		...
		String designationName=eLib.getExcelData("Sheet1", 1, 2)+intRanNum;
		...
		//Creating/Adding  the Designation//
		WebElement deptName=driver.findElement(By.id("dptName"));
		deptName.click();
		deptName.sendKeys("KeyEvent.PAGEDOWN");
		driver.findElement(By.id("desiName")).sendKeys(designationName+intRanNum);
		driver.findElement(By.name("btnSubmit")).click();
